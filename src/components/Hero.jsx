    ...
    <>
      <div class="bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradientBackground.png)] text-sm text-gray-500">
        <nav class="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 font-medium relative z-10 bg-white/80 backdrop-blur-md">
          <a href="https://prebuiltui.com">{/* Logo SVG */}</a>
          ...
          <ul
            id="nav-menu"
            class="hidden max-md:absolute top-full left-0 max-md:w-full md:flex md:items-center gap-8 max-md:bg-white max-md:shadow-md max-md:px-6 max-md:py-4 flex-col md:flex-row z-50"
          >
            <li>
              <a
                class="hover:text-indigo-500 md:hover:underline underline-offset-8 transition"
                href="#"
              >
                Home
              </a>
        ...
        <div class="h-[580px] flex flex-col items-center justify-center px-4 text-center">
          ...
          <div class="flex flex-wrap items-center justify-center gap-2.5 mb-6 border border-gray-500/30 rounded-full bg-gray-300/15 pl-4 p-1 text-sm text-gray-800 max-w-full">
            <p>Introducing a smoother way to travel.</p>
          ...
          <h1 class="text-3xl sm:text-5xl md:text-6xl font-bold max-w-4xl text-gray-800">
            Your Journey, Our Priority — Book Your Bus Tickets Seamlessly
          </h1>

          {/* Subheading */}
          <p class="max-w-xl text-center mt-6 px-4">
            Experience hassle-free bus booking with instant confirmations,
            trusted operators, and comfortable travel options. Plan, book & ride
            with confidence.
          </p>

          {/* Buttons */}
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            <button class="px-7 py-3 rounded bg-indigo-600 hover:bg-indigo-700 text-white font-medium">
              Book Now
            </button>
